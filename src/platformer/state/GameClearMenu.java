...
public class GameClearMenu extends BasicGameState{
	...
	private Game game;
	public GameClearMenu(Game game){
		this.game = game;
	}
	@Override
	...
	public void render(GameContainer container,StateBasedGame state,Graphics g)throws SlickException{
		...
		g.drawString("GAME CLEAR",container.getWidth()/2-(font2.getWidth("GAME CLEAR")/2),150);
		g.setFont(font1);
